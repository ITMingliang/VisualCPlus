...
BEGIN_MESSAGE_MAP(CMainFrame, CFrameWnd)
	...
	ON_WM_CREATE()
	ON_COMMAND(ID_TEST_MENU1, OnTestMenu1)
	ON_UPDATE_COMMAND_UI(ID_TEST_MENU1, OnUpdateTestMenu1)
	ON_COMMAND(ID_TEST_MENU2, OnTestMenu2)
	ON_UPDATE_COMMAND_UI(ID_TEST_MENU2, OnUpdateTestMenu2)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
