...
BOOL CDemoDlg::OnInitDialog()
{
	...
	// Add "About..." menu tvInsert to system menu.
...
void CDemoDlg::InitTree()
{
	...
	//在树控件中插入项
	HTREEITEM hRoot = m_ctrlTree.InsertItem(_T("Root"), 0, 0);
	...
	for (int i = 0; i < 4; i++)
	{
		...
		//在树控件中插项
		HTREEITEM hParent = m_ctrlTree.InsertItem(strText, 1, 1, hRoot);
		...
		for(int j = 0; j < 5; j++)
		{
			...
			//在树控件中插入项
			m_ctrlTree.InsertItem(strText, 2, 3, hParent);
		}
