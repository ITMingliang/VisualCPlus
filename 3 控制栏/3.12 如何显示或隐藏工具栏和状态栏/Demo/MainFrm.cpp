...
BEGIN_MESSAGE_MAP(CMainFrame, CMDIFrameWnd)
	...
	ON_UPDATE_COMMAND_UI(ID_SHOW_TOOLBAR, OnUpdateShowToolBar)
	ON_COMMAND(ID_SHOW_STATUSBAR, OnShowStatusBar)
	ON_UPDATE_COMMAND_UI(ID_SHOW_STATUSBAR, OnUpdateShowStatusBar)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
